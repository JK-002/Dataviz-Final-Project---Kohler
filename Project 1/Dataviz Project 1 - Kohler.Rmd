...
```{r, message = FALSE, warning = FALSE, fig.alt="Interactive column chart displaying the average number of daily U.S. births across the seven days of the week from 2000 to 2014. Weekdays from Monday through Friday show consistently elevated birth averages, while Saturdays and Sundays experience a rather notable drop in births down to approximately 7,500. This is possibly due to normal hospital scheduling for deliveries."}
