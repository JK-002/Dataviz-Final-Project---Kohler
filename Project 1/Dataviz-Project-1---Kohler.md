...
<img src="Dataviz-Project-1---Kohler_files/figure-html/unnamed-chunk-8-1.png" alt="Static column chart representing the normalized average daily U.S. births by month from 2000 to 2014. The x-axis lists the twelve months, and the y-axis tracks the daily average rate while accounting for calendar day bias. The bars show that the earlier months of January and February have lower numbers for average daily births, whereas an increase is seen in the summer month of August and September."  />
