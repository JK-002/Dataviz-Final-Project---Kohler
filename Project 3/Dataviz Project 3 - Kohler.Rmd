...
```{r, message=FALSE, warning=FALSE, fig.alt="An interactive time-series line plot tracking daily precipitation in Tampa. It features a prominent rainfall spike during indicating that the rainy season takes place during the summer months as well as the beginning of the fall season. This supported by a dark blue smoothing line highlighting whihc also emphasizes the summer rainy season."}
